...
interface SecureStorage {
    ...
    fun addWebsiteLoginCredential(websiteLoginCredentials: WebsiteLoginCredentials)
    ...
    @Throws(UserNotAuthenticatedException::class)
    fun updateWebsiteLoginCredentials(websiteLoginCredentials: WebsiteLoginCredentials)

    fun deleteWebsiteLoginCredentials(id: Int)
}
